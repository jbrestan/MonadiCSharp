...
namespace MonadiCSharp
{
    ...
    {
        public static IMaybe<TResult> Select<TValue, TResult>(this IMaybe<TValue> maybe, Func<TValue, TResult> selector)
        {
            return maybe.Bind(value => Ensure.NotNull(() => selector).Invoke(value).ToMaybe());
        }
